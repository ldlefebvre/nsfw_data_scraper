...
for f in $(ls /root/nsfw_data_scraper/scripts/1_*_.sh /root/nsfw_data_scraper/scripts/2_*_.sh /root/nsfw_data_scraper/scripts/5_*_.sh /root/nsfw_data_scraper/scripts/6_*_.sh)
do
    bash $f
done
